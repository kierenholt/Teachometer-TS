...
<html>
	...
	<link rel="stylesheet" type="text/css" href="styleRENAMED.css">
...
/* FRACTIONS */
section.present table.fraction {
...
section.present table.fraction > tbody > tr > td {
  border-style: none;
}

section.present table.fraction > tbody > tr:first-child > td {
...
.reveal .slides {
  ...
  overflow: visible;
  z-index: 1;
  /*text-align: center; this makes the text look awful*/ 
...
.no-transforms .reveal .slides {
  ...
  left: 50%;
  margin: 0;
/*  text-align: center; this makes the slides loook awful */}
...
.reveal h1 {
  font-size: 1.5em; } /* CHANGED BY KIEREN */
...
.reveal section img {
  margin: 15px 0px;
  /*background: rgba(255, 255, 255, 0.12); REMOVED */
  ...
  transition: width 800ms cubic-bezier(0.26, 0.86, 0.44, 0.985); }
	...
	<body>
		<div class="reveal">
			...
			<div class="slides" id="questionsDiv">
