...
enum IconName { "cross", "tick", "star", "trash", "duplicate", "hourglass", 
    "error", "refresh", "grid", "pin", "none"}; //none stays at the end!
...
class Icon extends ICup {
    ...
    iconName: IconName;
    constructor(parent: Container, iconName: IconName) {
        super(parent, "img");
...
.displayInlineBlock { display: block }
*/
    getIconName() {
